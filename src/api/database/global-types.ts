...
/**
 * Methods to use when ordering `Translator`.
 */
export enum TranslatorsOrderBy {
  ALIAS_ASC = "ALIAS_ASC",
  ALIAS_DESC = "ALIAS_DESC",
  CODE_ASC = "CODE_ASC",
  CODE_DESC = "CODE_DESC",
...
/**
 * A condition to be used against `Translator` object types. All fields are tested
 * for equality and combined with a logical ‘and.’
 */
export interface TranslatorCondition {
  id?: any | null;
  name?: string | null;
  alias?: string | null;
  code?: string | null;
