...
export interface Compiler_translator_language {
...
export interface Compiler_translator {
   ...
   */
  language: Compiler_translator_language | null;
}

export interface Compiler {
  translator: Compiler_translator | null;
}
