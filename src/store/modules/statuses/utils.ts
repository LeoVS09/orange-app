...
interface ISetStatus {
   (id: string, status: ModelStatus): void
}

interface ISetReadState {
   (id: string, read: ModelReadState): void
}

interface ISetModelState {
   (id: string, status: ModelStatus, read: ModelReadState): void
}

interface IGetStatus {
   (id: string): ModelStatus
}

interface IGetRead {
   (id: string): ModelReadState
}
